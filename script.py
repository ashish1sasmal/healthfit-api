clinics = ['Pristyn Care - Dwarka', 'Pristyn Care - Laxmi Nagar', 'Pristyn Care - Greater Kailash 1', 'Diyos Hospital (Tie up via Pristyn Care)', 'Akash Hospital (Tie up via Pristyn Care)', 'Pristyn Care - Saket', 'Pristyn Care - Hauz Khas', 'Pristyn Care - Paschim Vihar', 'Pristyn Care - Anand Vihar', 'Ayushmaan (Tie up via Pristyn Care)', 'Avantika Multispeciality Hospital (Tie up via Pristyn Care)', 'Bensups Hospital (Tie up via Pristyn Care)', 'Holy Angels Hospital (Tie up via Pristyn Care)', 'Medstar (Tie up via Pristyn Care)', 'New Vision Eye Centre (Tie up via Pristyn Care)', 'Sama Hospital (Tie up via Pristyn Care)', 'Aashlok Hospital', 'Eye7 Eye Hospitals', 'Reticure Eye Centre', 'Saroj Super Speciality Hospital', 'Rockland Hospital-Qutab', 'Sukhmani Hospital', 'Jaipur Golden Hospital', 'Orchid Hospital', 'Sri Balaji Action Medical Institute', 'Rajdhani Medical and Diagnostic Centre', 'Alshifa Multi Speciality Hospital', 'Sawan Neelu Angels Nursing Home', 'Medanta Hospital', 'Sehgal Neo Hospital', 'Vardaan Hospital', 'Bhagwati Hospital', 'Bhatia Global Hospital and Endosurgery Institute', 'Maxfort Hospital', 'MKW Hospital', 'NKS Hospital', 'Panchsheel Hospitals Pvt.Ltd.', 'Santom Hospital', 'Satyabhama Hospital Pvt. Ltd', 'Shanti Kumud Hospital', 'Suraksha Nursing Home', 'Balaji Hospital (Najafgarh)', 'Citizen Hospital', 'Dr Jain Ortho and Gyne Clinic', 'Geetanjali Medical Centre', 'Ishaan Hospital', 'Mohinder Hospital', 'Siddhant Hospital', 'Sinha Hospital', 'Smile N Care Dental Clinics', 'Sunrise Hospital', 'Apollo Spectra Hospital', 'Bhagwan Mahavir Hospital', 'Dental Renaissance', 'Dr Sumans Cosmetic Surgery and Skin Clinic', 'Dr.Roshan Lal Hospital', 'Ganesh Ortho Trauma and Medical Centre', 'Genesis Hospital', 'Global Ortho Clinic', 'Gupta Hospital', 'Jain Muni Roshanlal Hospital', 'Maheshwari Nursing Home', 'Mahindru Hospital', 'Narang Eye Institute', 'New Rohini Hospital', 'Parth Hospital', 'Virmani Hospital', '32 Strong - The Complete Dental Care', 'Aastha Hospital and IVF Centre', 'Apollo Spectra Hospitals (Karol Bagh)', 'Avantika Multispeciality Hospital', 'Chandra Leela Hospital', 'Chisel Clinic', 'Deepan Hospital', 'Dharma Vira Heart Centre (Sir Ganga Ram Hospital)', 'Dr B D Attam Hospital', 'Dr Chens Dental Clinic', 'Family Hospital Pvt. Ltd.', 'Flex Medical Centre', 'Gouri Hospital Limited', 'Jeevan Jyoti Hospital', 'Metro Clinic (New Delhi)', 'Orthonova Hospital', 'Puri Skin And laser Clinic', 'Radiance Cosmedic Centre', 'S. R. Liver and Gastro Clinic', 'Samadhan Dental and Gastro Clinic', 'Tandon Clinic', 'The Heart Center']

spec = ['Pediatric Dentist', 'Radiologist', 'Podiatrist', 'Internist', 'Physical Therapist', 'Refractive Surgeon', 'Facial Plastic & Reconstructive Surgeon', 'Family Physician', 'Oral Surgeon', 'Family Psychiatric & Mental Health Nurse Practitioner', 'Pain Management Specialist', 'Glaucoma Specialist', 'Hand Surgeon', 'Psychotherapist', 'Geriatrician', 'Physician Assistant', 'Child and Adolescent Psychiatrist', 'Pediatric Emergency Medicine Specialist', 'Laryngologist', 'Nurse Practitioner', 'Plastic Surgeon', 'Dermatologist', 'Pediatric Orthopedic Surgeon', 'Interventional Cardiologist', 'Psychiatrist', 'Endocrinologist', 'Hand & Microsurgery Specialist', 'Ear, Nose & Throat Doctor', 'Emergency Medicine Physician', 'Radiation Oncologist', 'Neuro-Ophthalmologist', 'Colorectal Surgeon', 'Family Nurse Practitioner', 'Chiropractor', 'Nuclear Medicine Specialist', "Women's Health Nurse Practitioner", 'Bariatric Surgeon', 'Spine Specialist', 'Hematologist', 'Prosthodontist', 'Dietitian', 'Infectious Disease Specialist', 'Dentist', 'Pulmonologist', 'Hip and Knee Surgeon', 'Adult Nurse Practitioner', 'Ophthalmologist', 'Midwife', 'Sleep Medicine Specialist', 'Travel Medicine Specialist', 'Periodontist', 'Cardiologist', 'Optometrist', 'OB-GYN', 'Urologist', 'Oculoplastic Surgeon', 'Pediatric / Strabismus Eye Doctor', 'Pediatric Nurse Practitioner', 'Foot & Ankle Specialist', 'Head & Neck Surgeon', 'Pediatric Dermatologist', 'Pediatric Sports Medicine Specialist', 'Primary Care Doctor', 'Forensic Psychiatrist', 'Neurologist', 'Clinical Neurophysiologist', 'Pediatric Cardiologist', 'Addiction Specialist', 'Neuro-Otologist', 'Physiatrist', 'Sinus Surgeon / Rhinologist', 'Surgeon', 'Anesthesiologist', 'Nephrologist', 'Orthopedic Surgeon', 'Psychologist', 'Occupational Therapist', 'Allergist', 'Acupuncturist', 'Vascular Surgeon', 'Sports Medicine Specialist', 'Cornea & External Diseases Specialist', 'Gastroenterologist', 'Rheumatologist', 'Orthodontist', 'Urgent Care Specialist', 'Urological Surgeon', 'Retina Specialist (Medical)', 'Audiologist', 'Nutritionist', 'Adult Psychiatric & Mental Health Nurse Practitioner', 'Diagnostic Radiologist', 'Pediatric Otolaryngologist', 'Neurosurgeon', 'Psychosomatic Medicine Specialist', 'Oncologist', 'Reproductive Endocrinologist', 'Pediatrician', 'Gynecologist', 'Pulmonary Diseases and Critical Care Medicine Specialist', 'Shoulder & Elbow Surgeon', 'Endodontist']
