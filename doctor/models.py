...
SPECIALIZATION_CHOICES = (('Dentist', 'Dentist'), ('Surgeon', 'Surgeon'), ('Nose, Throat & Ear', 'Nose, Throat & Ear'), ('Pediatrics', 'Pediatrics'), ('Orthopedics', 'Orthopedics'),)
...
class Doctor(models.Model):
    ...
    specialization = models.CharField(max_length=40, choices=SPECIALIZATION_CHOICES, default=None)
    ...
    profile_pic = models.CharField(max_length=500, default='https://mpcthospital.in/wp-content/uploads/2019/02/doctor-profile-350x350.png')
    verified = models.BooleanField(default=False)
    clinic = models.ForeignKey(Address, related_name="address_doctor", blank=True, null=True, on_delete=models.DO_NOTHING)
